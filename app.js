const sessions = [
  { number: 1, tag: 'Day 1', filterKey: 'day-1', type: 'talk', date: '2 October 2026', day: 'Friday', time: '6:00 PM–7:15 PM PKT', end: '7:30 PM–8:45 PM PKT', title: 'Foundations — Qubits, Gates & Superposition', formLink: 'https://forms.gle/WNx5xcZ9uoygQLXt6', speaker: 'Dustin Rippe; Dr. Fatima Bint-e-Munir', speakerTopics: [
    ...
    { name: 'Dr. Fatima Bint-e-Munir', topics: ['Single-qubit gates: X, H, Z, Y, S, T', 'Superposition'] }
  ] },
  ...
  { number: 3, tag: 'Day 3', filterKey: 'day-3', type: 'talk', date: '4 October 2026', day: 'Sunday', time: '6:00 PM–8:30 PM PKT', end: '', breakNote: 'Break: 7:15 PM–7:30 PM PKT', title: 'Multi-Qubit Circuits & Entanglement', formLink: 'https://forms.gle/g9JkxJLBYn6qrKd58', speaker: 'Dr. Fatima Bint-e-Munir', topics: ['Multi-qubit state representation', 'Tensor products', 'Entanglement and lab demonstration', 'Bell states', 'GHZ states'] },
  ...
  { number: 6, tag: 'Day 6', filterKey: 'day-6', type: 'talk', date: '11 October 2026', day: 'Sunday', time: '6:00 PM–7:45 PM PKT', end: '8:00 PM–8:45 PM PKT', title: 'Dynamic Circuits & Parameterized Circuits', formLink: 'https://forms.gle/QKHtyFNgtkfAwwai9', speaker: 'Fatima Shahzadi; Dr. Fatima Bint-e-Munir', speakerTopics: [
    { name: 'Dr. Fatima Bint-e-Munir', topics: ['Classical registers', 'Mid-circuit measurement', 'Conditional logic', 'Dynamic circuits: step-by-step explanation'] },
